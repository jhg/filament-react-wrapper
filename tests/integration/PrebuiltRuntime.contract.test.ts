...
describe('prebuilt Composer runtime', () => {
  ...
  it('mounts a registered field and bridges its value through Livewire', async () => {
...
async function waitForElement(document: JSDOM['window']['document'], selector: string): Promise<HTMLElement> {
